...
function Card({username, btnText = 'Click Here'}) {  // components can use props object or we can destructure it directly 'click here' is the default value if the value of btnText is not provided
  return (
    <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
      ...
      <div className="flex items-center justify-between">
        <button type = "button" className="px-4 py-2 bg-white hover:bg-gray-200 text-black text-sm rounded-lg transition-colors duration-200">
          {btnText}
        </button>
